            ...
            <Link to="/profile" className="shrink-0">
              {puppy?.photoUrl ? (
                <img
                  ...
                  className="w-10 h-10 rounded-full object-cover border-2 border-sand-200 shadow-sm hover:border-steel-300 transition-colors"
                />
              ) : (
                <div className="w-10 h-10 rounded-full bg-sand-100 border-2 border-sand-200 flex items-center justify-center text-lg hover:border-steel-300 transition-colors">
                  🐶
                </div>
              )}
            </Link>
